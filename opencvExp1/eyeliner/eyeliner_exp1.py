...
def get_inner_and_outer_points(points_eyeliner_eye, points_eyeliner_eyebrow):
...
def draw_points_right(img_rgb, points_eyebrow, points_eye):
    points_eyeliner_eye, points_eyeliner_eyebrow = find_points_eyeliner_right(points_eyebrow, points_eye)
    points_poly_eye_fill_outer, points_poly_eye_fill_inner =  get_inner_and_outer_points(points_eyeliner_eyebrow, points_eyeliner_eye)
...
def draw_points_left(img_rgb, points_eyebrow, points_eye):
    points_eyeliner_eye, points_eyeliner_eyebrow = find_points_eyeliner_left(points_eyebrow, points_eye)
    points_poly_eye_fill_outer, points_poly_eye_fill_inner = get_inner_and_outer_points(points_eyeliner_eyebrow, points_eyeliner_eye)
...
def draw_eyelines(img_rgb):
    ...
    img_out = draw_points_left(img_rgb, points_left_eyebrow, points_left_eye)
    img_out = draw_points_right(img_out, points_right_eyebrow, points_right_eye)
    return img_out

img_bgr = cv2.imread('woman4.jpg')
img_rgb = cv2.cvtColor(img_bgr, cv2.COLOR_BGR2RGB)

img_out = draw_eyelines(img_rgb)
